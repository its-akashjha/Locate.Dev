...
function About() {
  ...
  <a href="https://www.instagram.com/its_akashjha/" target="_blank" rel="noopener noreferrer">
   <img
    ...
    />
          ...
          <a href="https://github.com/its-akashjha" target="_blank" rel="noopener noreferrer" className="text-white font-Hublot leading-5 tracking-wider pb-2 jack-sheehy">
          🔥 Akash Jha :) <br />
            ©2024
          </a>
        </div>
